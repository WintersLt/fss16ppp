...
# TODO 2: We normalize so that all the objectives are compared using the same range(normally between 0 and 1).
...
def igd(obtained, ideals):
  ...
  igd_val = sum(map(lambda i:  closest(i,obtained)[0],ideals))/len(ideals)
